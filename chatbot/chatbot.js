(function () {
    ...
    function init() {
         ...
         * keep the suggestions collapsed so the
         * greeting/orientation remains the focus.
         */
    ...
    function handleSubmit() {
        ...
        /*
         * Once the visitor asks something,
         * keep the suggestion drawer compact.
         */
    ...
    function resetChatbot() {
        ...
        /*
         * Start over returns to the original
         * first-time visitor state:
